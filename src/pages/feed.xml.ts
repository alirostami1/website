// thid code is copied from https://github.com/delucis/astro-blog-full-text-rss 
// at the time of writing the main branch has is not compatible with Astro 5
// which is fixed in https://github.com/delucis/astro-blog-full-text-rss/issues/10
//
...
export async function GET(context: APIContext) {
    ...
    for (const post of posts) {
        ...
        feedItems.push({ ...post.data, author: "Ali Rostami", link: `/blog/${post.id}/`, content });
    }
